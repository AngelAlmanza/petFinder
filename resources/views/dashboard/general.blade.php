...
@section('content')
    ...
    <div class="flex flex-wrap w-full align-center justify-center">
        <x-card-dashboard title="Total de usuarios" image="fa-solid fa-user" description="{{ $totalUsuarios }}" chart="none"/>
        ...
        <x-card-dashboard title="Total mascotas encontradas" image="fa-solid fa-heart" description="{{ $totalPetsFound }}" chart="none"/>
