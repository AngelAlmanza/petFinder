<article {{ $attributes->merge(['class' => 'w-11/12 max-w-xl h-60 mx-auto p-4 flex items-end flex-col justify-around shadow-md rounded-lg']) }}>
    ...
    <div class="w-full">
        <p class="mt-1 text-base font-normal text-stone-800 mb-1">{{ $category }}</p>
        <p class="text-base font-normal text-stone-800 overflow-hidden">{{ $body }}</p>
    </div>
