<div class="w-72 bg-slate-50 rounded-lg shadow-md p-4 md:w-80">
    ...
    @if ($type)
        <p class="text-xs font-normal text-stone-800 mb-4">Acepta animales exoticos</p>
    @else
        <p class="text-xs font-normal text-stone-800 mb-4">No acepta animales exoticos</p>
    @endif
